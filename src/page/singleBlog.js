...
import blog from '../assets/images/blogLarge.png'
                ...
                <div className='grid grid-cols-12 gap-4 mt-12'>
                    <div className='col-span-4'>
                        <div className='flex justify-end'>
                            <div>
                                <p className='text-white font-semibold text-lg text-right'>John Eve</p>
                                <p className='text-[#00FFFC] Brockmann text-right'>Nov 17, 2020</p>
                            </div>
                            <img src={profile} alt='profile image' className='ml-3 w-[50px] h-[50px]' />
                        </div>
            ...
            <div className='w-large mx-auto'>
                <div className='grid grid-cols-12 gap-4'>
                    <div className='col-span-12'>
                        <p className='text-white mt-5 text-center w-[80%] mx-auto Gilroy text-base'>
